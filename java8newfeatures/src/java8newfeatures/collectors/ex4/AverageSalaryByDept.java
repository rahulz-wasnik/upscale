package java8newfeatures.collectors.ex4;
...
public class AverageSalaryByDept {
	...
	public static void main(String[] args) {
		...
		Map<String, Double> result = list.stream().collect(Collectors.groupingBy(departmentId, Collectors.averagingInt(Employee::getSalary)));
