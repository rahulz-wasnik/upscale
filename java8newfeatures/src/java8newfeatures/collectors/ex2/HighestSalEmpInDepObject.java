...
public class HighestSalEmpInDepObject {
	...
	public static void main(String[] args) {
		...
		Map<String, Optional<Employee>> employee = list.stream().collect(Collectors.groupingBy(departmentId, Collectors.reducing(BinaryOperator.maxBy(Comparator.comparing(Employee::getSalary)))));
